...
function HomeContent() {
  ...
  return (
    <div style={{ width: '100%', display: 'flex', justifyContent: 'center', background: '#FAFAF8', minHeight: '100vh' }}>
      ...
      <div style={{ width: '100%', maxWidth: '1240px', padding: '24px 24px 80px', margin: '0 auto', boxSizing: 'border-box' }}>

        {/* ======================================================== */}
        {/* HERO PROMO BANNER (WORLD-CLASS APPLE BOOKS / NETFLIX UI) */}
        {/* ======================================================== */}
        {!q && (
          <div style={{ width: '100%', marginBottom: '44px', marginTop: '4px' }}>
            <div 
              style={{
                position: 'relative',
                width: '100%',
            ...
            >
              ...
              {/* SISI KIRI (Teks & Tombol CTA - Lebar 55%) */}
              <div style={{
                flex: '1 1 55%',
                zIndex: 10,
                display: 'flex',
              ...
              {categories.map(cat => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontSize: '0.813rem', fontWeight: isSelected ? 800 : 600, color: isSelected ? '#1E40AF' : '#0F172A', textAlign: 'center', lineHeight: 1.2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%' }}>
                      {cat.name}
                    </span>
                  </div>
                );
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
              ...
              <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center' }}>
                <div style={{ position: 'absolute', left: '12px', pointerEvents: 'none', color: selectedCategory !== 'ALL' ? '#2563EB' : '#64748B', display: 'flex', alignItems: 'center' }}>
                  <Layers size={14} />
                </div>
                <select
              ...
              <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center' }}>
                <div style={{ position: 'absolute', left: '12px', pointerEvents: 'none', color: selectedTimeSort !== 'NEWEST' ? '#2563EB' : '#64748B', display: 'flex', alignItems: 'center' }}>
                  <Clock size={14} />
                </div>
                <select
              ...
              <div style={{ position: 'relative', display: 'inline-flex', alignItems: 'center' }}>
                <div style={{ position: 'absolute', left: '12px', pointerEvents: 'none', color: selectedMetricFilter !== 'ALL' ? '#2563EB' : '#64748B', display: 'flex', alignItems: 'center' }}>
                  <Sparkles size={14} />
                </div>
                <select

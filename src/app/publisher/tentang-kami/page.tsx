...
export default function TentangKamiPage() {
  ...
  useEffect(() => {
    router.replace('/publisher?view=tentang');
  }, [router]);
  return (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid #F1F5F9' }}>
                <div style={{ fontSize: 'clamp(2.5rem, 4vw, 3.5rem)', fontWeight: 900, color: '#0F172A', lineHeight: 1, marginBottom: '8px' }}>
                  50+
                </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ fontSize: '0.938rem', color: '#64748B', lineHeight: 1.65, margin: 0 }}>
